...
shwarzminiburne = Actor.create!(username: "Stéphanie Cotillon", mail: "shwarz@mail.com", description: "J’adore les mariages ! Je suis une vraie folle quand je m’élance sur le dancefloor. Spécialisée en Madison, je sais aussi endiabler les Démons de Minuit.", price: 1000, user_id: noemie.id, category: "Événement")

constantin_le_tarniner = Actor.create!(username: "John Gendreidéal", mail: "letartiner@mail.com", description: "Vos parents ont toujours rêvé de vous voir avec un vétérinaire, doux, aimant et assez musclé pour soulever une vache ? Je suis l’homme de la situation. Je peux aussi jouer le gendre horrible pour contrarier belle-maman.", price: 10, user_id: juan.id, category: "Famille")
...
gorge_clowné = Actor.create!(username: "Coline Love", mail: "jorge@mail.com", description: "Ton date prend l’eau, et tu veux prendre le large ? Je serai l’amie qui t’aide à te sortir des dates claqués. Appelle-moi et je déboule avec une urgence top secrete.", price: 10, user_id: noemie.id, category: "Amour")

samousa_jackson = Actor.create!(username: "Magali Pilierdebar", mail: "samouelo@mail.com", description: "Vous venez d’ouvrir un établissement nocture ou diurne mais vous peinez à attirer du monde ? Mes copines et moi on viendra mettre le feu sur la terrasse : aucun badaud ne résistera à l’envie de s’arrêter pour boire un verre dans le nouveau bar à la mode.", price: 10, user_id: cyril.id, category: "Événement")
